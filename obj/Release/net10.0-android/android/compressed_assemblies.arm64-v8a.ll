...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [151 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2222080, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 16701080; uint32_t buffer_offset
	}, ; 148: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 16872088; uint32_t buffer_offset
	}, ; 149: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2061312, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 16893624; uint32_t buffer_offset
	} ; 150: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 18954936, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [18954936 x i8] zeroinitializer, align 1
